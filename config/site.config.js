...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'snow@onedrive2020.onmicrosoft.com',
  ...
  protectedRoutes: ['/vercel', '/🥟 Some test files/Protected route'],
